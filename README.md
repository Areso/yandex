...
4. download download https://dl.google.com/linux/direct/chrome-remote-desktop_current_amd64.deb (for Chrome Remote Desktop)
5. `docker build --tag yandex:1.0 .`  
6. `sudo docker run -p 127.0.0.1:5900:5900 --name yandex -d yandex:1.0`  
